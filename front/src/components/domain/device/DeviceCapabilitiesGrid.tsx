      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
        {capabilities.map((cap) => (
          <div
            ...
            className={`group bg-white p-4 rounded-xl border border-gray-200 shadow-sm ${selectedCapability == cap.name ? "border-primary-600": "hover:shadow-md hover:border-primary-200"} transition-all duration-200 flex flex-col justify-between`}
          >
